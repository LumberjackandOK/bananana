...
use Acme\CounterBundle\Form\ItemType;
...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeCounterBundle:Item')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeCounterBundle:Item:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeCounterBundle:Item')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmeCounterBundle:Item:edit.html.twig")
     */
